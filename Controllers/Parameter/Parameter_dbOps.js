...
var get_Parameter_Setting=async (req,res)=>{ 
  ...
  const request = pool.request();
                 ...
                 var sp_name='sp_Parameter_Setting_Get';    
            try{
...
const request =  await pool.request();
 ...
 module.exports={get_Parameter_Setting:get_Parameter_Setting,edit_Seller_Commission_Setting:edit_Seller_Commission_Setting,newProduct:newProduct,newUsers:newUsers,editUsers:editUsers,deleteUsers:deleteUsers}