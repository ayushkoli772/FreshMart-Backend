...
const moment = require('moment');
  var getPromotionProducts=async (req,res)=>{
    ...
    const request = pool.request();
                   ...
                   var sp_name='sp_Promotion_Products_Get';    
              try{
 ...
 var formatDate=(date)=> {
  ...
  var newPromotionProduct=async (req,res)=>{

    var id=0;
    if(req.params.id==null){ id=0;}else{id=req.params.id;}
    console.log('req.body.startDate:'+req.body.startDate);
    //console.log('formatted req,body.startDate:'+formatDate(req.body.startDate))
   // const dateObject_startDate = moment(req.body.startDate).toDate();
   // console.log('dateObject_startDate:'+dateObject_startDate)
...
var sp_name='sp_PromotionProduct_AddEdit';
 ...
 module.exports={getPromotionProducts,newPromotionProduct,deletePromotionProduct}